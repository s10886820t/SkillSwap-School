...
public class ReviewServiceTest {
    ...
    public static void main(String[] args) {
        ...
        ExchangeService exchangeService
                = new ExchangeService(service.getStorage(), service.getState());
        ...
        ReviewService reviewService
                = new ReviewService(service.getStorage(), service.getState());
        ...
        System.out.println("ReviewServiceTest completato");
    }
}
